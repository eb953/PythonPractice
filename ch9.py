...
## Lottery 
from random import choice 
my_list = [1,7,9,'A','C',3,'DD',84,'EF',22,'BD',64]

for find_match in range(4):
    match = choice(my_list)
    print(f"\nAny ticket that matches with the selction, {match}, wins a prize")

##The above does not account for repeats 
